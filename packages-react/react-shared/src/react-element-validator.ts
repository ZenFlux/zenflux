...
import reactIsValidElementType from "@zenflux/react-shared/src/react-is-valid-element-type";
...
import { cloneElement, createElement, isValidElement, jsxDEV } from "@zenflux/react-shared/src/react-element";
import { describeUnknownElementTypeFrameInDEV } from "@zenflux/react-shared/src/react-component-stack-frame";
...
const didWarnAboutKeySpread: any = {};
...
export function createFactoryWithValidation( type: any ) {
    const validatedFactory = createElementWithValidation( type );

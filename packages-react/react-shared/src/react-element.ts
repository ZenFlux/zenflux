...
function hasValidKey( config: { key: undefined; } ): boolean {
    if ( __DEV__ ) {
    ...
    if ( __DEV__ ) {
        if (
            ...
            if ( null === componentName ) {
                throw new Error(
                    "getComponentNameFromType can't find a component's name in the current context.",
                );
            }
 ...
 * @internal
 */
function ReactElement( type: any, key: string | null, ref: any, self: undefined, source: undefined, owner: Fiber | null, props: {} ) {
    const element = {
 ...
 * https://github.com/reactjs/rfcs/pull/107
 */
export function jsxDEV( type: any, config: any, maybeKey: unknown, source: undefined, self: undefined ) {
    let propName;
...
export function cloneAndReplaceKey( oldElement: any, newKey: string | null ) {
    return ReactElement(
        oldElement.type,
        newKey,
        oldElement.ref,

...
describe( 'isomorphic act()', () => {
    beforeEach( () => {
        ...
        React = require( 'react' );
        ReactXEnvAct = require( '@zenflux/react-x-env/act' );
        ...
        DiscreteEventPriority = require( '@zenflux/react-reconciler/constants' ).DiscreteEventPriority;

        act = ReactXEnvAct.act;
        use = ReactXEnvHooks.use;

...
describe( 'ReactSuspenseList', () => {
    ...
    it( 'warns if an unsupported revealOrder option is used', async () => {
        ...
        await expect( async () => {
            ...
            'something is not a supported value for revealOrder on <SuspenseList />. Did you mean "together", "forwards" or "backwards"?'
        ], { withoutStack: true } );
    } );
    ...
    it( 'warns if a upper case revealOrder option is used', async () => {
        ...
        await expect( async () => {
            ...
            'TOGETHER is not a supported value for revealOrder on <SuspenseList />. Did you mean "together", "forwards" or "backwards"?',
        ], { withoutStack: true } );
    } );
    ...
    it( 'warns if a misspelled revealOrder option is used', async () => {
        ...
        await expect( async () => {
            ...
            'forward is not a supported value for revealOrder on <SuspenseList />. Did you mean "together", "forwards" or "backwards"?',
        ], { withoutStack: true } );
    } );
    ...
    it( 'warns if an unsupported tail option is used', async () => {
        ...
        await expect( async () => {
            ...
            '"collapse" is not a supported value for tail on <SuspenseList />. Did you mean "collapsed" or "hidden"?'
        ], { withoutStack: true } );
    } );

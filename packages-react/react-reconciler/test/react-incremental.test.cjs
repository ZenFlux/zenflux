...
describe( 'ReactIncremental', () => {
    ...
    it( 'does not leak own context into context provider (factory components)', async () => {
        ...
        await expect(
            ...
            'The <Recurse /> component appears to be a function component that returns a class instance. ' +
    ...
    it( 'does not break with a bad Map polyfill', async () => {
        ...
        let InternalTestUtils = require( '@zenflux/react-internal-test-utils' );
        ...
        // Wait for timeout to ensure ReactNoop is initialized.
        await waitFor( [] );
        ...
        InternalTestUtils = require( '@zenflux/react-internal-test-utils' );

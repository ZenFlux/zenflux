...
describe( 'ReactCache', () => {
    beforeEach( () => {
        ...
        ReactInternalUtils = require( '@zenflux/react-internal-test-utils' );

        Cache = React.unstable_Cache;
        Suspense = React.Suspense;
        cache = React.cache;

        React.createElement = require( '@zenflux/react-shared/src/react-element-validator' ).createElementWithValidation;

        Activity = React.unstable_Activity;

        startTransition = React.startTransition;
        useState = ReactXEnvHooks.useState;

        useCacheRefresh = ReactXEnvHooks.useCacheRefresh;
        getCacheSignal = ReactXEnvHooks.getCacheSignal;

        assertLog = ReactInternalUtils.assertLog;
        act = ReactInternalUtils.act;

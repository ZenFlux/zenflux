        ...
        describe( `${ label }`, () => {
            ...
            it( 'validates nested propTypes declarations', async () => {
                ...
                await expect( async () => {
                    ...
                    'Failed prop type: Invalid prop `outer` of type `string` supplied to `Inner`, expected `number`.',
                    'Failed prop type: Invalid prop `middle` of type `string` supplied to `Inner`, expected `number`.',
                    'Failed prop type: Invalid prop `inner` of type `string` supplied to `Inner`, expected `number`.',
                ], { withoutStack: 2 } );

...
describe( 'ReactHooksWithNoopRenderer', () => {
    ...
    it( 'throws inside module-style components', async () => {
        ...
        await expect(
            ...
            'The <Counter /> component appears to be a function component that returns a class instance. ' +
    ...
    describe( 'useEffect', () => {
        ...
        it( 'flushSync is not allowed', async () => {
            ...
            } ).toErrorDev( 'flushSync was called from inside a lifecycle method', { withoutStack: true } );
            assertLog( [ `Count: 0` ] );
            expect( ReactNoop ).toMatchRenderedOutput( <span prop="Count: 0"/> );
        } );

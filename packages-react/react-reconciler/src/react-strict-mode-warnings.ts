...
if ( __DEV__ ) {
    const findStrictRoot = ( fiber: Fiber ): Fiber | null => {
        ...
        while ( node !== null ) {
            if ( node.mode & TypeOfMode.StrictLegacyMode ) {
    ...
    ReactStrictModeWarnings.recordUnsafeLifecycleWarnings = ( fiber: Fiber, instance: any ) => {
        ...
        if ( fiber.mode & TypeOfMode.StrictLegacyMode && typeof instance.UNSAFE_componentWillMount === "function" ) {
        ...
        if ( fiber.mode & TypeOfMode.StrictLegacyMode && typeof instance.UNSAFE_componentWillReceiveProps === "function" ) {
        ...
        if ( fiber.mode & TypeOfMode.StrictLegacyMode && typeof instance.UNSAFE_componentWillUpdate === "function" ) {

...
export function getNearestMountedFiber( fiber: Fiber ): null | Fiber {
    ...
    if ( ! fiber.alternate ) {
        ...
        do {
            ...
            if ( ( node.flags & ( FiberFlags.Placement | FiberFlags.Hydrating ) ) !== FiberFlags.NoFlags ) {
...
export function getContainerFromFiber( fiber: Fiber ): null | Container {
    return fiber.tag === WorkTag.HostRoot ? ( fiber.stateNode.containerInfo as Container ) : null;
}
...
export function isMounted( component: Component ): boolean {
    if ( __DEV__ ) {
        ...
        if ( owner !== null && owner.tag === WorkTag.ClassComponent ) {
...
function findCurrentHostFiberWithNoPortalsImpl( node: Fiber ): Fiber | null {
    ...
    if ( tag === WorkTag.HostComponent || ( enableFloat ? tag === WorkTag.HostHoistable : false ) || ( enableHostSingletons ? tag === WorkTag.HostSingleton : false ) || tag === WorkTag.HostText ) {
        return node;
    }
...
export function isFiberSuspenseAndTimedOut( fiber: Fiber ): boolean {
    ...
    return fiber.tag === WorkTag.SuspenseComponent && memoizedState !== null && memoizedState.dehydrated === null;
}

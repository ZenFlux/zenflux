...
export function completeBoundaryWithStyles( suspenseBoundaryID, contentID, stylesheetDescriptors ) {
    ...
    Promise.all( dependencies ).then( completeBoundary.bind( null, suspenseBoundaryID, contentID, "" ), completeBoundary.bind( null, suspenseBoundaryID, contentID, "Resource failed to load" ) );
}

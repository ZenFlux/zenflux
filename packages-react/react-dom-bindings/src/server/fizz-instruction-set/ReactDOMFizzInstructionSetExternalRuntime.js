...
exports.completeBoundaryWithStyles = exports.completeSegment = exports.completeBoundary = exports.clientRenderBoundary = void 0;
/* eslint-disable dot-notation */
// Instruction set for the Fizz external runtime
var ReactDOMFizzInstructionSetShared_1 = require("@zenflux/react-dom-bindings/src/server/ReactDOMFizzInstructionSetShared");
Object.defineProperty(exports, "clientRenderBoundary", { enumerable: true, get: function () { return ReactDOMFizzInstructionSetShared_1.clientRenderBoundary; } });
Object.defineProperty(exports, "completeBoundary", { enumerable: true, get: function () { return ReactDOMFizzInstructionSetShared_1.completeBoundary; } });
Object.defineProperty(exports, "completeSegment", { enumerable: true, get: function () { return ReactDOMFizzInstructionSetShared_1.completeSegment; } });
...
function completeBoundaryWithStyles(suspenseBoundaryID, contentID, stylesheetDescriptors) {
    var precedences = new Map();
    var thisDocument = document;
    var lastResource, node;
    ...
    while (true) {
        if (sheetMode) {
            ...
            if (loadingState && loadingState["s"] !== "l" && (!media || window["matchMedia"](media).matches)) {
    ...
    Promise.all(dependencies).then(ReactDOMFizzInstructionSetShared_1.completeBoundary.bind(null, suspenseBoundaryID, contentID, ""), ReactDOMFizzInstructionSetShared_1.completeBoundary.bind(null, suspenseBoundaryID, contentID, "Resource failed to load"));
}
exports.completeBoundaryWithStyles = completeBoundaryWithStyles;
if (react_feature_flags_1.enableFormActions) {
    (0, ReactDOMFizzInstructionSetShared_1.listenToFormSubmissionsForReplaying)();
}

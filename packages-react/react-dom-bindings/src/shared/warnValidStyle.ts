...
function warnHyphenatedStyleName( name: string ) {
    if ( __DEV__ ) {
...
function warnBadVendoredStyleName( name: string ) {
    if ( __DEV__ ) {
        if ( warnedStyleNames.hasOwnProperty( name ) && warnedStyleNames[ name ] ) {
            return;
        }
...
function warnStyleValueWithSemicolon( name: string, value: any ) {
    if ( __DEV__ ) {
...
function warnStyleValueIsNaN( name: string, value: any ) {
    if ( __DEV__ ) {
...
// eslint-disable-next-line @typescript-eslint/no-unused-vars
function warnStyleValueIsInfinity( name: string, value: any ) {
    if ( __DEV__ ) {
...
function warnValidStyle( name: string, value: any ) {
    if ( __DEV__ ) {
        if ( name.indexOf( "-" ) > -1 ) {

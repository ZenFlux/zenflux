...
function validateProperty( tagName: string, name: any, value: any, eventRegistry: any ) {
    if ( __DEV__ ) {
        ...
        if ( possibleStandardNames.hasOwnProperty( lowerCasedName ) ) {
            const standardName = possibleStandardNames[ lowerCasedName as keyof typeof possibleStandardNames ];
...
function warnUnknownProperties( type: string, props: any, eventRegistry: any ) {
    if ( __DEV__ ) {
        ...
        const unknownPropString = unknownProps.map( ( prop: string ) => "`" + prop + "`" ).join( ", " );
...
export function validateProperties( type: string, props: any, eventRegistry: any ) {

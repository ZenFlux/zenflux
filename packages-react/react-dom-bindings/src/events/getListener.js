...
function getListener(inst, registrationName) {
    ...
    if (listener && typeof listener !== "function") {
        throw new Error("Expected `".concat(registrationName, "` listener to be a function, instead got a value of `").concat(typeof listener, "` type."));
    }
    return listener;
}
exports.default = getListener;

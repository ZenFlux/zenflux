 ...
 */
const vendorPrefixes: Record<"animationend" | "animationiteration" | "animationstart" | "transitionend", ReturnType<typeof makePrefixMap>> = {
 ...
 */
const prefixedEventNames: Record<any, any> = {};

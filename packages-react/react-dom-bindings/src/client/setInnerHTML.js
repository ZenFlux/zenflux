...
function setInnerHTMLImpl(node, html) {
    if (node.namespaceURI === DOMNamespaces_1.SVG_NAMESPACE) {
        if (__DEV__) {
            if (react_feature_flags_1.enableTrustedTypesIntegration) {
        ...
        if (!("innerHTML" in node)) {
            ...
            while (svgNode === null || svgNode === void 0 ? void 0 : svgNode.firstChild) {

...
export type AncestorInfoDev = {
    current: Info | null | undefined;
    formTag: Info | null | undefined;
    aTagInScope: Info | null | undefined;
    buttonTagInScope: Info | null | undefined;
    nobrTagInScope: Info | null | undefined;
    pTagInButtonScope: Info | null | undefined;
    listItemTagAutoclosing: Info | null | undefined;
    dlItemTagAutoclosing: Info | null | undefined;
    // <head> or <body>
    containerTagInScope: Info | null | undefined;
};
...
function updatedAncestorInfoDev( oldInfo: AncestorInfoDev | null | undefined, tag: string ): AncestorInfoDev {
    if ( __DEV__ ) {
        const ancestorInfo = {
 ...
 * Returns whether
 */
function isTagValidWithParent( tag: string, parentTag: string | null | undefined ): boolean {
    ...
    switch ( tag ) {
        ...
        case "rp":
        case "rt":
            return impliedEndTags.indexOf( parentTag as string ) === -1;
 ...
 * Returns whether
 */
function findInvalidAncestorForTag( tag: string, ancestorInfo: AncestorInfoDev ): Info | null | undefined {
    switch ( tag ) {
        case "address":
        case "article":
        case "aside":
...
const didWarn: Record<string, boolean> = {};

function validateDOMNesting( childTag: string, ancestorInfo: AncestorInfoDev ): void {
    if ( __DEV__ ) {

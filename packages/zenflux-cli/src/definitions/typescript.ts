...
export type TZTS7Diagnostic = {
    ...
    // Resolved by `zTS7ResolvePosition()`, 1 based.
    line?: number,
    character?: number,
};
...
export interface IZTS7ApiInstance {
    updateSnapshot( params: { openProjects: string[] } ): IZTS7Snapshot;
...
export type TZTS7Api = {
    API: new ( options?: { cwd?: string } ) => IZTS7ApiInstance,

    // Attached by `zTS7ResolveApiModule()`, the version of the package it resolved.
    zVersion?: string,
};
